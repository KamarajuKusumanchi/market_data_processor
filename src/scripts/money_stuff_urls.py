...
# Sample usage:
# raju@DESKTOP-CRLPVE5 MINGW64 ~
# $ conda activate market_data_processor
# $ python $market_data_processor/src/scripts/money_stuff_urls.py --page 1
#
...
def fetch_articles(
    ...
    if response.status_code == 403:
        # Printing the url here will be handy in case you want to update the cookies file.
        print (f"Request to {response.url} failed with 403 Forbidden error.", file=sys.stderr)
        print("Maybe cookies are outdated or invalid.", file=sys.stderr)
